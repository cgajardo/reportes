<html>
<body>
    <a href="<?php echo str_replace("index.php","",$_SERVER['PHP_SELF']);?>instituciones">Instituciones</a><br/>
    <a href="<?php echo str_replace("index.php","",$_SERVER['PHP_SELF']);?>sedes">Sedes</a><br/>
    <a href="<?php echo str_replace("index.php","",$_SERVER['PHP_SELF']);?>contenidos">Ver contenidos</a><br/>
